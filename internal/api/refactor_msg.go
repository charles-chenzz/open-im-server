...
func NewMessage(discov discoveryregistry.SvcDiscoveryRegistry) Message {
	return Message{
		Message:       rpcclient.NewMessage(discov),
		validate:      validator.New(),
		userRpcClient: rpcclient.NewUserRpcClientByUser(rpcclient.NewUser(discov)),
	}
}
...
func (m Message) newUserSendMsgReq(_ *gin.Context, params *apistruct.SendMsg) *msg.SendMsgReq {
...
func (m *Message) getSendMsgReq(c *gin.Context, req apistruct.SendMsg) (sendMsgReq *msg.SendMsgReq, err error) {
	var data interface{}
...
func (m *Message) SendBusinessNotification(c *gin.Context) {
	req := struct {
		Key        string `json:"key"`
...
func (m *Message) BatchSendMsg(c *gin.Context) {
	var (
...
// GetSendMsgStatus also known as GetUsersOnlineStatus
func (m *Message) GetSendMsgStatus(c *gin.Context) {
	a2r.Call(msg.MsgClient.GetSendMsgStatus, m.Client, c)
}

func (m *Message) GetActiveUser(c *gin.Context) {
	a2r.Call(msg.MsgClient.GetActiveUser, m.Client, c)
}

func (m *Message) GetActiveGroup(c *gin.Context) {
	a2r.Call(msg.MsgClient.GetActiveGroup, m.Client, c)
}

func (m *Message) SearchMsg(c *gin.Context) {
	a2r.Call(msg.MsgClient.SearchMessage, m.Client, c)
}

func (m *Message) GetServerTime(c *gin.Context) {
